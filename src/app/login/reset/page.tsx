...
import { Mail, ArrowLeft, Sparkles, ShieldCheck, AlertCircle } from 'lucide-react';
    ...
    <div className="w-full max-w-md">
      ...
      >
        ...
        <div className="mt-6 text-center">
          <Link
            href="/login"
            className="inline-flex items-center gap-1.5 text-xs font-bold text-primary/60 hover:text-primary uppercase tracking-wider transition-colors"
          >
